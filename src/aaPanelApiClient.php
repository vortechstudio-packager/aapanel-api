...
namespace AlfikriPayakumbuh\AAPanelAPI;
 ...
 * documentation: https://github.com/AlfikriPayakumbuh/aapanel-api
 */
class aaPanelApiClient
{
    private $apiKey;
     ...
     * @param string $pathCookie Path to save cookie
     */
    public function __construct($apiKey, $baseUrl, $pathCookie)
    {
        $this->apiKey  = $apiKey;
